 ...
 *
 * Not `/[locale]/build/[slug]` — i18n (ACM-023) is not implemented yet and
 * will relocate this route once it lands (see task implementation notes).
 */
export default async function PublicBuildPage({ params }: PageProps): Promise<React.JSX.Element> {
  ...
  const lookups = await buildCardLookupsFor(build.content);
